				...
				<div
					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6 text-right">
							<p>
								<em>Data dostawy: <fmt:formatDate type="date"
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							<address>
								<strong>Adres kontaktowy</strong> <br>
					...
					<div class="row">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Wartosc zamowienia</th>
								</tr>
							</thead>
							<tbody>
						...
						<button type="submit" class="btn btn-success"
							...
							Potwierdz zamowienie   <span class="glyphicon glyphicon-chevron-right"></span>
						</button>
						<button id="btnCancel" class="btn btn-default"
							name="_eventId_cancel">Anuluj zamowienie</button>
					</div>
				</div>
			</form:form>
		</div>
